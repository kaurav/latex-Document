...
\newcommand{\projecttitle}{\Huge \bf{COMPUTER NETWORKS-II\\(CODE-BTCS 507)}\vskip 0.5in}
\newcommand{\tab}[1]{\hspace{.4\textwidth}\rlap{#1}}
\newcommand{\itab}[1]{\hspace{.05\textwidth}\rlap{#1}}
\newcommand{\logo}[1]{\includegraphics[scale=0.23]{#1}}
\newcommand{\submitted}{
\vskip 0.4in
...
{Submitted To:}\\
\textnormal{\\CSE Department \\                                                                                     } % Supervisor's Name
\end{flushright}
\end{minipage}\\[2cm]
\HRule \\[0.4cm]
